...
from climbcast.views import AddRoute, UpdateRoute, UpdateUser
...
urlpatterns = patterns('',
        ...
        url(r'^cragguser/(?P<user_name_slug>[\w\-]+)/$', cache_page(60 * 1200)(views.cragguser), name='cragguser'),
        ...
        url(r'^cragguser/update/(?P<user_name_slug>[\w\-]+)/$', UpdateUser.as_view(), name='user_update_form'),
